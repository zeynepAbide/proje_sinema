				...
				try {
					...
					while(myRs.next()) {
						if(adiSoyadi.equals(myRs.getString("adi_soyadi"))&& pass.equals(myRs.getString("sifre"))){
							JOptionPane.showMessageDialog(anaprogram.this,"Giriş Yapıldı!!!","Uyarı ",JOptionPane.WARNING_MESSAGE);
							setVisible(false);
							new FilmSecimi().setVisible(true);
							}else {
			                    JOptionPane.showMessageDialog(anaprogram.this,"Kayıtlı kişi bulunamadı!!!", "Uyarı", JOptionPane.WARNING_MESSAGE);			                
							}
				}
