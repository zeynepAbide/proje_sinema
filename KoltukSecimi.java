...
public class KoltukSecimi extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					KoltukSecimi frame = new KoltukSecimi();
	...
	public KoltukSecimi() {
		...
		tabbedPane.setBounds(6, 6, 915, 560);
		contentPane.add(tabbedPane);
		
		JPanel panel = new JPanel();
		panel.setBackground(new Color(123, 0, 34));
		tabbedPane.addTab("Salon 1", null, panel, null);
		...
		btnNewButton.setBounds(68, 107, 55, 50);
		...
		btnNewButton_1.setBounds(133, 107, 55, 50);
		...
		btnNewButton_2.setBounds(198, 107, 55, 50);
		...
		btnNewButton_3.setBounds(263, 107, 55, 50);
		...
		btnNewButton_4.setBounds(328, 107, 55, 50);
		...
		btnNewButton_5.setBounds(393, 107, 55, 50);
		...
		btnNewButton_6.setBounds(458, 107, 55, 50);
		...
		btnNewButton_7.setBounds(523, 107, 55, 50);
		...
		btnNewButton_8.setBounds(585, 107, 55, 50);
		...
		btnNewButton_9.setBounds(650, 107, 55, 50);
		...
		btnNewButton_10.setBounds(715, 107, 55, 50);
		...
		btnNewButton_11.setBounds(780, 107, 55, 50);
		...
		btnNewButton_12.setBounds(68, 200, 55, 50);
		...
		btnNewButton_13.setBounds(133, 200, 55, 50);
		...
		btnNewButton_14.setBounds(198, 200, 55, 50);
		...
		btnNewButton_15.setBounds(263, 200, 55, 50);
		...
		btnNewButton_16.setBounds(328, 200, 55, 50);
		...
		btnNewButton_17.setBounds(393, 200, 55, 50);
		...
		btnNewButton_18.setBounds(458, 200, 55, 50);
		...
		btnNewButton_19.setBounds(523, 200, 55, 50);
		...
		btnNewButton_20.setBounds(585, 200, 55, 50);
		...
		btnNewButton_21.setBounds(650, 200, 55, 50);
		...
		btnNewButton_22.setBounds(715, 200, 55, 50);
		...
		btnNewButton_23.setBounds(780, 200, 55, 50);
		...
		btnNewButton_24.setBounds(68, 296, 55, 50);
		...
		btnNewButton_25.setBounds(133, 296, 55, 50);
		...
		btnNewButton_26.setBounds(198, 296, 55, 50);
		...
		btnNewButton_27.setBounds(263, 296, 55, 50);
		...
		btnNewButton_28.setBounds(328, 296, 55, 50);
		...
		btnNewButton_29.setBounds(393, 296, 55, 50);
		...
		btnNewButton_30.setBounds(458, 296, 55, 50);
		...
		btnNewButton_31.setBounds(523, 296, 55, 50);
		...
		btnNewButton_32.setBounds(585, 296, 55, 50);
		...
		btnNewButton_33.setBounds(650, 296, 55, 50);
		...
		btnNewButton_34.setBounds(715, 296, 55, 50);
		...
		btnNewButton_35.setBounds(780, 296, 55, 50);
		...
		btnNewButton_36.setBounds(294, 370, 55, 50);
		...
		btnNewButton_37.setBounds(376, 370, 55, 50);
		...
		btnNewButton_38.setBounds(458, 370, 55, 50);
		...
		btnNewButton_39.setBounds(545, 370, 55, 50);
		...
		txtPerde_1.setBounds(68, 32, 767, 19);
		panel.add(txtPerde_1);
		...
		lbldolu.setBounds(319, 443, 55, 50);
		panel.add(lbldolu);
		...
		lblboş.setBounds(432, 443, 55, 50);
		panel.add(lblboş);
		...
		lblseç.setBounds(545, 443, 55, 50);
		panel.add(lblseç);
		...
		txtDoluKoltuk_1.setBounds(301, 503, 90, 19);
		panel.add(txtDoluKoltuk_1);
		...
		txtBoKoltuk_1.setBounds(422, 503, 79, 19);
		panel.add(txtBoKoltuk_1);
		...
		txtSeilenKoltuk_1.setBounds(525, 504, 105, 19);
		panel.add(txtSeilenKoltuk_1);
		txtSeilenKoltuk_1.setColumns(10);
		
		
		JPanel panel_1 = new JPanel();
		panel_1.setBackground(new Color(123, 0, 34));
		tabbedPane.addTab("Salon 2", null, panel_1, null);
		...
		btnNewButton1.setBounds(101, 107, 55, 50);
		...
		btnNewButton_111.setBounds(166, 107, 55, 50);
		...
		btnNewButton_211.setBounds(231, 107, 55, 50);
		...
		btnNewButton_311.setBounds(296, 107, 55, 50);
		...
		btnNewButton_411.setBounds(361, 107, 55, 50);
		...
		btnNewButton_51.setBounds(426, 107, 55, 50);
		...
		btnNewButton_61.setBounds(491, 107, 55, 50);
		...
		btnNewButton_71.setBounds(556, 107, 55, 50);
		...
		btnNewButton_81.setBounds(621, 107, 55, 50);
		...
		btnNewButton_91.setBounds(686, 107, 55, 50);
		panel_1.add(btnNewButton_91);
		...
		btnNewButton_101.setBounds(751, 107, 55, 50);
		panel_1.add(btnNewButton_101);
		...
		btnNewButton_1111.setBounds(101, 222, 55, 50);
		panel_1.add(btnNewButton_1111);
		...
		btnNewButton_121.setBounds(166, 222, 55, 50);
		panel_1.add(btnNewButton_121);
		...
		btnNewButton_131.setBounds(231, 222, 55, 50);
		panel_1.add(btnNewButton_131);
		...
		btnNewButton_141.setBounds(296, 222, 55, 50);
		panel_1.add(btnNewButton_141);
		...
		btnNewButton_151.setBounds(361, 222,55, 50);
		panel_1.add(btnNewButton_151);
		...
		btnNewButton_161.setBounds(426, 222, 55, 50);
		panel_1.add(btnNewButton_161);
		...
		btnNewButton_171.setBounds(491, 222, 55, 50);
		panel_1.add(btnNewButton_171);
		...
		btnNewButton_181.setBounds(556, 222,55, 50);
		panel_1.add(btnNewButton_181);
		...
		btnNewButton_191.setBounds(621, 222, 55, 50);
		panel_1.add(btnNewButton_191);
		...
		btnNewButton_201.setBounds(686, 222, 55, 50);
		panel_1.add(btnNewButton_201);
		...
		btnNewButton_2111.setBounds(751, 222,  55, 50);
		panel_1.add(btnNewButton_2111);
		...
		btnNewButton_221.setBounds(139, 332,  55, 50);
		panel_1.add(btnNewButton_221);
		...
		btnNewButton_231.setBounds(203, 332,  55, 50);
		panel_1.add(btnNewButton_231);
		...
		btnNewButton_241.setBounds(268, 332,  55, 50);
		panel_1.add(btnNewButton_241);
		...
		btnNewButton_251.setBounds(333, 332, 55, 50);
		panel_1.add(btnNewButton_251);
		...
		btnNewButton_261.setBounds(398, 332,  55, 50);
		panel_1.add(btnNewButton_261);
		...
		btnNewButton_271.setBounds(463, 332,  55, 50);
		panel_1.add(btnNewButton_271);
		...
		btnNewButton_281.setBounds(528, 332,  55, 50);
		panel_1.add(btnNewButton_281);
		...
		btnNewButton_291.setBounds(593, 332,  55, 50);
		panel_1.add(btnNewButton_291);
		...
		btnNewButton_301.setBounds(658, 332, 55, 50);
		panel_1.add(btnNewButton_301);
		...
		btnNewButton_3111.setBounds(723, 332, 55, 50);
		panel_1.add(btnNewButton_3111);
		...
		txtPerde.setBounds(101, 36, 705, 19);
		panel_1.add(txtPerde);
		...
		lblNewLabel.setBounds(319, 443, 55, 50);
		...
		lblNewLabel_1.setBounds(432, 443, 55, 50);
		panel_1.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("seçilen_koltuk");
		Image img7=new ImageIcon(this.getClass().getResource("/yeşil.png")).getImage();
		lblNewLabel_2.setIcon(new ImageIcon(img7));
		lblNewLabel_2.setBounds(545, 443, 55, 50);
		...
		txtDoluKoltuk.setBounds(301, 504, 90, 19);
		panel_1.add(txtDoluKoltuk);
		...
		txtSeilenKoltuk.setBounds(525, 504, 105, 19);
		panel_1.add(txtSeilenKoltuk);
		...
		txtBoKoltuk.setBounds(423, 504, 77, 19);
		panel_1.add(txtBoKoltuk);
